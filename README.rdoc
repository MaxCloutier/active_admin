...
on Rails 4 application. To install, simply add the following to your Gemfile:
  ...
  # to use the ixmedia template use the ixmedia branch for activeadmin
  gem 'activeadmin',         github: 'MaxCloutier', branch: 'html5'
...
Add this to the [project]/config/initializers/active_admin.rb so the create/edit methods work in rails 4
...
To change the translation add this to lib/active_admin/application.rb
